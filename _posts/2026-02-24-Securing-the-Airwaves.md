...
Working with the WLC (192.168.100.254), I defined the SSIDs and mapped them to the appropriate VLANs. A critical step was ensuring the Access Points (APs) could join the controller and broadcast the secure SSID.  
